    ...
    return [
      {
        ...
        jumlah_judul_penelitian_ts_2: 0,
        jumlah_judul_penelitian_ts_1: 0,
        jumlah_judul_penelitian_ts: 0,
        jumlah: 0,
      },
      {
  ...
  getFieldNames(item) {
    ...
    const patterns = {
      ts2: [
        ...
        /^.*penelitian.*ts[-_]?2.*$/i, // jumlah_judul_penelitian_ts_2
      ],
      ts1: [
        /^.*ts[-_]?1.*$/i, // ts_1, ts-1, ts1
        /^.*penelitian.*ts[-_]?1.*$/i, // jumlah_judul_penelitian_ts_1
      ],
      ts: [
        /^.*penelitian.*ts$/i, // jumlah_judul_penelitian_ts (tanpa _1 atau _2)
        /^.*ts$/i, // field yang berakhiran ts tapi bukan ts_1/ts_2
      ],
      jumlah: [
        /^jumlah$/i, // exact match "jumlah"
        /^total$/i, // exact match "total"
        /^.*jumlah(?!.*penelitian).*$/i, // mengandung jumlah tapi bukan penelitian
      ],
      sumber: [
    ...
    const result = {
      ts2: fieldMapping.ts2 || "jumlah_judul_penelitian_ts_2",
      ts1: fieldMapping.ts1 || "jumlah_judul_penelitian_ts_1",
      ts: fieldMapping.ts || "jumlah_judul_penelitian_ts",
