...
export class LuaranPenelitianPkmYangDihasilkanMahasiswaHKIPatenPlugin extends BasePlugin {
  constructor() {
    super({
      ...
      description:
        "Plugin for processing Luaran Penelitian/PkM yang Dihasilkan Mahasiswa - HKI (Paten, Paten Sederhana)",
    })
  }
  ...
  configureSection(config) {
    return {
      ...config,
      isLuaranPenelitianMahasiswaHKIPaten: true,
    }
  }
...
export const luaranPenelitianPkmYangDihasilkanMahasiswaHKIPatenPlugin =
  new LuaranPenelitianPkmYangDihasilkanMahasiswaHKIPatenPlugin()

export default luaranPenelitianPkmYangDihasilkanMahasiswaHKIPatenPlugin
