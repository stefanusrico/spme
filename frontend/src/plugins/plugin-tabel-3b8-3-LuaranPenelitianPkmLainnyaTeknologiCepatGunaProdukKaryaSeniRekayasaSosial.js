...
const LuaranPenelitianPkmLainnyaTeknologiTepatGunaProduk = createPluginHandler({
  ...
  validationRules: [
    ...
    {
      field: "status_tingkat_kesiapan_teknologi",
      message: "Status Tingkat Kesiapan Teknologi harus diisi",
    },
    {
      field: "nomor_sertifikat_tkt",
      message: "Nomor Sertifikat TKT harus diisi",
    },
  ],
