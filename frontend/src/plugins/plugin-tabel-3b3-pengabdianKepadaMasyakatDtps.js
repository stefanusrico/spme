...
const PengabdianKepadaMasyarakatDtpsPlugin = createPluginHandler({
  ...
  validationRules: [
    {
      field: "ts_2_jumlah_judul_pkm",
      message: "TS-2 Jumlah Judul PkM harus diisi",
    },
    {
      field: "ts_1_jumlah_judul_pkm",
      message: "TS-1 Jumlah Judul PkM harus diisi",
    },
    {
      field: "ts_jumlah_judul_pkm",
      message: "TS Jumlah Judul PkM harus diisi",
    },
  ],
