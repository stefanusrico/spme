  ...
  validateData(data) {
    ...
    data.forEach((item, index) => {
      ...
      const requiredFields = [
        {
          field: item.nama_dosen_2,
          message: `Row ${index + 1}: Nama dosen harus diisi`,
        },
        {
          field: item.ts_2_nomor_sk_penugasan_pembimbing,
          message: `Row ${index + 1}: Nomor SK TS-2 harus diisi`,
        },
        {
          field: item.ts_1_nomor_sk_penugasan_pembimbing,
          message: `Row ${index + 1}: Nomor SK TS-1 harus diisi`,
        },
        {
          field: item.ts_nomor_sk_penugasan_pembimbing,
          message: `Row ${index + 1}: Nomor SK TS harus diisi`,
        },
      ]
      ...
      if (
        ...
        errors.push(
          `Row ${
            index + 1
          }: Data TS-2, TS-1, TS pada jumlah mahasiswa yang dibimbing pada PS yang diakreditasi tidak sama dengan rata-ratanya`
        )
      }
      ...
      if (
        ...
        errors.push(
          `Row ${
            index + 1
          }: Data TS-2, TS-1, TS pada jumlah mahasiswa yang dibimbing pada PS Lain di PT tidak sama dengan rata-ratanya`
        )
      }
    })
