...
const LuaranPenelitianPkmLainnyaBukuBerIsbnBookChapter = createPluginHandler({
  ...
  validationRules: [
    {
      field: "judul_luaran_penelitian_dan_pkm",
      message: "Judul Luaran Penelitian dan PkM harus diisi",
    },
    {
      field: "tanggal_hh_bb_tttt",
      message: "Tanggal (HH/BB/TTTT) harus diisi",
    },
    {
      field: "keterangan_nomor_isbn",
      message: "Keterangan (Nomor ISBN) harus diisi",
    },
  ],
  ...
  scoreCalculator: async function (data, config, additionalData) {
    ...
    const responseScoreDetail = await fetchScoreDetails("3a1", additionalData.projectId)
