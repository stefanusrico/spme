          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="flex justify-end mt-6">
              <button
                type="button"
                onClick={handleClose}
                className={`mr-4 px-4 py-2 text-sm font-medium text-gray-700 bg-gray rounded-lg hover:bg-gray-200 ${
                  isSubmitting ? "opacity-50 cursor-not-allowed" : ""
                }`}
                disabled={isSubmitting}
              >
              ...
              <button
                type="submit"
                className={`px-4 py-2 text-sm font-medium text-white bg-base rounded-lg hover:bg-yellow-600 ${
                  isSubmitting ? "opacity-50 cursor-not-allowed" : ""
                }`}
                disabled={isSubmitting}
              >
