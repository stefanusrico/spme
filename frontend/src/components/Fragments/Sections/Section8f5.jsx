...
const LuaranPenelitianPkmMahasiswa = () => {
    ...
    const defaultData = [
      {
        key: 1,
        no: "I",
        judulLuaran: "HKI: a) Paten, b) Paten Sederhana",
        tahun: "",
        keterangan: "",
      },
      ...
      },
      {
        ...
        no: "III",
        judulLuaran:
          "Teknologi Tepat Guna, Produk: Produk Terstandarisasi, Produk Tersertifikasi",
        tahun: "",
        keterangan: "",
      },
      ...
      },
      {
        key: 13,
        no: "IV",
        judulLuaran: "Buku Ber-ISBN, Book Chapter",
        tahun: "",
        keterangan: "",
      },
  ...
  const mergedRowRender = (value, record) => {
    return record.isMerged
      ? {
          children: value,
          props: { colSpan: 4, style: { fontWeight: "bold" } },
        }
      : value
  }
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-4">
        Luaran Penelitian/PkM Lainnya oleh Mahasiswa
      </h2>
      <Table
