...
const AddUser = ({ title = "Add User" }) => {
  ...
  const handleChange = async () => {
      try {
        ...
        if (!user.name || !user.email || !user.username || !user.role || !user.password || !user.verifPass) {
        ...
        try {
            console.log("gagal1");
            const response = await axios.post(`http://localhost:8000/api/users/`, dataToStore, 
                {
                    headers: {
                      Authorization: `Bearer ${token}`, 
                    },
                ...
                <div className="flex space-x-16">
                    ...
                    <div className="mt-10 ml-10 flex flex-col">
                        ...
                        <InputForm
                            ...
                            onChange={(e) => setUser({ ...user, verifPass: e.target.value })}
                            disabled={isLoading}
                            required
                        />
                    </div>
