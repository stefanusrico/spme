...
const UserManagement = ({title = ["User Management","Permission Management"]}) => {
  ...
  const handleAdd = () => {
    mode == 1 ? navigate('/user-management/user/add') : navigate('/user-management/role/add')
  }
  ...
  return (
    <div className="flex min-h-screen bg-graybackground">
        ...
        <div className="fixed justify w-[75%] ml-72 pt-20">
            <div className="h-[calc(100vh-5rem)] overflow-y-auto hide-scrollbar"> {/* Tambahkan scroll Y */}
                    ...
                    <div className="flex gap-5 items-center">
                        ...
                        >
                            ...
                            <span
                                ...
                                mode === 1 ? "w-[55px] scale-x-100" : "w-0 group-hover:w-[55px] group-hover:scale-x-100"
                                }`}
                            ></span>
                        </div>
                        ...
                        >
                            ...
                            <span
                                className={`absolute left-1/2 -translate-x-1/2 bottom-0 h-[2px] bg-primary transition-all duration-300 ease-in-out ${
                                mode === 2 ? "w-[80px] scale-x-100" : "w-0 group-hover:w-[80px] group-hover:scale-x-100"
                                }`}
                            ></span>
                        </div>
                    </div> 
