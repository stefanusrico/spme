...
const PengisianLed = () => {
  ...
  useEffect(() => {
    // Cleanup toast saat component unmount atau navigasi
    return () => {
      toast.dismiss()
    }
  }, [])
  ...
  useEffect(() => {
    // Cleanup toast saat no/sub berubah
    toast.dismiss()
  ...
  const handleShowToast = () => {
    ...
    toast(
      ...
      />,
      {
        toastId: toastId, // Berikan ID unik
        position: "bottom-right",
        autoClose: false,
        closeOnClick: false,
        draggable: false,
        closeButton: false, // Disable close button default
      }
    )
  }
  ...
  return (
    <div className="h-[80vh] w-auto mt-4 mr-4 pb-4 overflow-y-auto bg-white shadow-lg rounded-lg p-4">
      <ToastContainer
        ...
        limit={3} // Batasi jumlah toast maksimal
