...
class ScoreCalculator
{
    ...
    // private function getBobotButir($lamId, $strataId)
    // {
    //     try {
    //         $dataBobot = BobotButir::where('lamId', $lamId)->where('strataId', $strataId)->get();
    //         return $dataBobot;
    //     } catch (\Throwable $th) {
    //         return response()->json([
    //             'status' => 'error',
    //             'message' => " Bobot Butir Not Found By strataId : {$strataId}, and lamId : {$lamId}"
    //         ], 404);
    //     }
    // }
